...
var authConfig = {
  ...
  refresh_token: "1//0d0DEeN0_i2u4CgYIARAAGA0SNwF-L9IrX1aLYvBdUdljySJHMdoghK-t5v5lf-imJo9ziiQe0MfwFyZghU7zasOzRo1AHCoNpxM",
  "roots": [
	{
		"id": "1QxbQ-gSyT0EiiCCmYeIWMGTGeIfUvjmD",
		"name": "ROOT",
		"user": "",
		"pass": "",
...
<html>
<head>
<meta charset="utf-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0,maximum-scale=1.0, user-scalable=no"/> <title>${authConfig.siteName}</title> <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1"><meta name="description" content="Combining the power of Cloudflare Workers and Google Drive will allow you to index your files on the browser on Cloudflare Workers."><meta name="theme-color" content="#FF0000"><meta name="application-name" content="https://github.com/THEALIFHAKER1/AE1-INDEX"><meta name="robots" content="index, follow"><meta name="twitter:card" content="summary"><meta name="twitter:image" content="https://telegra.ph/file/ab593a45722dba672dde2.png"><meta name="twitter:description" content="Combining the power of Cloudflare Workers and Google Drive will allow you to index your files on the browser on Cloudflare Workers."><meta name="keywords" content="https://github.com/THEALIFHAKER1/AE1-INDEX, google, drive, https://github.com/THEALIFHAKER1/AE1-INDEX, gdindex, classic, material, workers-script, oauth-consent-screen, google-drive, cloudflare-workers, themes"><meta name="twitter:title" content="https://github.com/THEALIFHAKER1/AE1-INDEX"><meta name="twitter:url" content="https://github.com/THEALIFHAKER1/AE1-INDEX"><link rel="shortcut icon" href="https://telegra.ph/file/ab593a45722dba672dde2.png"><meta property="og:site_name" content="https://github.com/THEALIFHAKER1/AE1-INDEX"><meta property="og:type" content="website"><meta property="og:image" content="https://telegra.ph/file/ab593a45722dba672dde2.png"><meta property="og:description" content="Combining the power of Cloudflare Workers and Google Drive will allow you to index your files on the browser on Cloudflare Workers."><meta property="og:title" content="https://github.com/THEALIFHAKER1/AE1-INDEX"><meta property="og:url" content="https://github.com/THEALIFHAKER1/AE1-INDEX"><link rel="apple-touch-icon" href="https://telegra.ph/file/ab593a45722dba672dde2.png"><link rel="icon" type="image/png" sizes="32x32" href="https://telegra.ph/file/ab593a45722dba672dde2.png"><meta name="google-site-verification" content="OD_AXMYw-V6ID9xQUb2Wien9Yy8IJSyfBUyejYNB3CU"/><script async src="https://www.googletagmanager.com/gtag/js?id=UA-86099016-6"></script><script>window.dataLayer=window.dataLayer || []; function gtag(){dataLayer.push(arguments);}gtag('js', new Date()); gtag('config', 'UA-86099016-6');</script><script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-MR47R4M');</script> <style>@import url(${themeOptions.cdn}@${themeOptions.version}/https://github.com/THEALIFHAKER1/AE1-INDEX-acrou/dist/style.min.css); </style> <script>window.gdconfig=JSON.parse('${JSON.stringify({version: authConfig.version, themeOptions: themeOptions,})}'); window.themeOptions=JSON.parse('${JSON.stringify(themeOptions)}'); window.gds=JSON.parse('${JSON.stringify( authConfig.roots.map((it)=> it.name) )}'); window.MODEL=JSON.parse('${JSON.stringify(model)}'); window.current_drive_order=${current_drive_order}; </script>
</head>
<body>
